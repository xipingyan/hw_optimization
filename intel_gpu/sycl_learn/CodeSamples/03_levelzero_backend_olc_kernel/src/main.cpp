...
int main()
{
    ...
    auto lz_dev = sycl::get_native<cl::sycl::backend::ext_oneapi_level_zero, sycl::device>(dev);
    auto lz_ctx = sycl::get_native<cl::sycl::backend::ext_oneapi_level_zero, sycl::context>(ctx);
